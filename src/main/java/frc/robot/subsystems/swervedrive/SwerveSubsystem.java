...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  public void addVisionMeasurement(String limelightName) {
    ...
    else if (poseEstimateMT2.tagCount >= 1) {
      mostRecentVisionMeasurement = poseEstimateMT2.pose.getTranslation();
      Pose2d pose = new Pose2d(mostRecentVisionMeasurement, swerveDrive.getPose().getRotation());
      swerveDrive.addVisionMeasurement(pose, poseEstimateMT2.timestampSeconds);
    }
  }

  public Translation2d getMostRecentVisionMeasurement() {
    return mostRecentVisionMeasurement;
  }
